...
public class SnmpTrapReceiverWorker implements CommandResponder {

	private static final Logger logger = LoggerFactory.getLogger(SnmpTrapReceiverWorker.class);
